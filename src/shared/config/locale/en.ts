...
export const en: LocaleBundle = {
  ...
  dictionary: {
    ...
    backupTooLarge: 'Backup is larger than 25 MB. Remove some media or save a copy via “Export to file”.',
    driveAuthDeveloper: 'Google rejected the app signature (SHA-1). Debug builds need the debug certificate; Play installs need the SHA-1 from Play Console → App signing.',
    driveAuthPlayServices: 'Google Play Services are missing or need an update.',
    driveAuthDenied: 'No access to app data on Google Drive. Sign in with a Test users account and grant access.',
