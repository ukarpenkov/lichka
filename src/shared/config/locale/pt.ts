...
export const pt: LocaleBundle = {
  ...
  dictionary: {
    ...
    backupTooLarge: 'O backup tem mais de 25 MB. Remova parte da mídia ou salve uma cópia em «Exportar para arquivo».',
    driveAuthDeveloper: 'O Google rejeitou a assinatura do app (SHA-1). Builds debug precisam do certificado debug; instalações da Play, do SHA-1 em Play Console → App signing.',
    driveAuthPlayServices: 'O Google Play Services está indisponível ou precisa ser atualizado.',
    driveAuthDenied: 'Sem acesso aos dados do app no Google Drive. Entre com uma conta de Test users e conceda o acesso.',
