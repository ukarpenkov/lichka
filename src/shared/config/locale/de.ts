...
export const de: LocaleBundle = {
  ...
  dictionary: {
    ...
    linkOpenFailed: 'Link konnte nicht geöffnet werden',
    ...
    backupTooLarge: 'Die Sicherung ist größer als 25 MB. Entferne Medien oder speichere eine Kopie über „In Datei exportieren“.',
    driveAuthDeveloper: 'Google hat die App-Signatur (SHA-1) abgelehnt. Debug-Builds brauchen das Debug-Zertifikat, Play-Installationen den SHA-1 aus Play Console → App signing.',
    driveAuthPlayServices: 'Google Play Services fehlen oder müssen aktualisiert werden.',
    driveAuthDenied: 'Kein Zugriff auf App-Daten in Google Drive. Mit einem Test-users-Konto anmelden und Zugriff erlauben.',
