...
export const fr: LocaleBundle = {
  ...
  dictionary: {
    ...
    backupTooLarge: 'La sauvegarde dépasse 25 Mo. Supprimez des médias ou enregistrez une copie via « Exporter vers un fichier ».',
    driveAuthDeveloper: "Google a refusé la signature de l'appli (SHA-1). Les builds debug nécessitent le certificat debug ; les installs Play, le SHA-1 de Play Console → App signing.",
    driveAuthPlayServices: 'Google Play Services est indisponible ou doit être mis à jour.',
    driveAuthDenied: "Pas d'accès aux données de l'appli sur Google Drive. Connectez-vous avec un compte Test users et autorisez l'accès.",
