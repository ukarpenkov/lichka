...
export const es: LocaleBundle = {
  ...
  dictionary: {
    ...
    backupTooLarge: 'La copia supera 25 MB. Elimina parte de los archivos multimedia o usa «Exportar a archivo».',
    driveAuthDeveloper: 'Google rechazó la firma de la app (SHA-1). Las builds debug necesitan el certificado debug; las instalaciones de Play, el SHA-1 de Play Console → App signing.',
    driveAuthPlayServices: 'Google Play Services no está disponible o necesita actualizarse.',
    driveAuthDenied: 'Sin acceso a los datos de la app en Google Drive. Entra con una cuenta de Test users y concede el acceso.',
