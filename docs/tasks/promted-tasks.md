...
- [x] **5.1 Экран списка чатов (ChatList)**
...
- [x] **5.2 Виджет создания/редактирования чата (ChatForm)**
...
- [x] **5.3 Экран чата (ChatRoom) — лента сообщений**
...
- [x] **5.4 Компонент ввода сообщений (MessageComposer)**
...
- [x] **5.5 Picker даты/времени (DateTimePicker)**
...
- [x] **5.6 Picker периодичности (PeriodPicker)**
...
- [x] **5.7 Виджет голосового сообщения (VoiceMessage)**
...
- [x] **6.1 Экран «Запланировано» (Scheduled)**
...
- [x] **7.1 Экран «Настройки» (Settings)**
...
- [x] **7.2 Экран выбора темы (ThemePicker)**
...
- [x] **10.1 Реализовать редактирование сообщений**
...
- [x] **10.2 Реализовать удаление сообщений и чатов**
...
- [x] **11.1 Реализовать глобальный поиск**
  На экране `ChatList`:
...
- [x] **11.2 Реализовать поиск по чату**
  На экране `ChatRoom`:
  — Иконка поиска в заголовке → поле поиска
...
- [x] **14.1 Добавить анимации переходов и micro-interactions**
...
- [x] **15.1 Настроить локализацию RU + EN**
...
- [x] **16.1 Реализовать первый запуск (дефолтный чат)**
...
- [x] **17.1 Собрать всё вместе — провайдеры и инициализация**
  В `App.tsx`:
...
- [x] **17.2 Пройтись по всем требованиям и проверить покрытие**
