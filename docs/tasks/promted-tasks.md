...
> **Итог:** после выполнения всех промтов должно получиться рабочее приложение, соответствующее всем требованиям из `docs/spec/white-requirements.md`. Всё хорошо.
...
- [ ] **1.3 Создать FTS5 миграцию и функцию поиска**
