...
8. ✅ ChatRoom chrome + GlobalSearch / SearchOverlay / menus / composer на no-divider + semantic tokens.
9. ⬜ Прогнать light / dark / mint / cream на устройстве (скриншоты).
10. ⬜ Date grouping в Scheduled (UX follow-up).
11. ⬜ DateTimePicker / PeriodPicker — убрать `#4A9EFF` brand accent.
