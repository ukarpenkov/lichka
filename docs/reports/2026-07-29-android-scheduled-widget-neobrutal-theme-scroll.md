...
- `android/app/src/main/res/layout/widget_scheduled.xml` — FrameLayout + plate ImageView + `ListView` вместо статичных строк
- `android/app/src/main/res/layout/widget_scheduled_row.xml` — layout строки списка (новый)
