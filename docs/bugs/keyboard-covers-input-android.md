...
## Исправление
Добавить `androidWindowSoftInputMode: 'adjustResize'` в опции экрана `ChatRoom` в `AppNavigator.tsx`. Это заставит `react-native-screens` применить `adjustResize` к ScreenFragment этого экрана, а не `adjustNothing`.
